...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private Button rescuerLoginBT, userLoginBT, vehicleLoginBT;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        vehicleLoginBT = (Button) findViewById(R.id.vehicleLoginButton);
        vehicleLoginBT.setOnClickListener(this);
