...
public class LoginActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (type.equals("rescuer"))
        {
            ...
            url = "http://" + ip + "/flood/rescuerlogin.php";
        }
        else if (type.equals("user"))
            url = "http://"+ ip + "/flood/userLogin.php";
        else if (type.equals("vehicle"))
        {
            loginSignUpTextLL.setVisibility(View.GONE);
            url = "http://"+ ip + "/flood/vehicleLogin.php";
        }
                ...
                if(response.contains("Failed")){
                    ...
                    try{
                        ...
                        if (type.equals("user")) {
                            ...
                            globalPreference.addVID(uid);
                            intent = new Intent(LoginActivity.this, VehicleHomeActivity.class);
                        }
